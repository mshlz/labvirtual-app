...
export const ActivityStudentCard = (props: IActivityStudentCard) => {
    const Extra = (
        <Typography.Text type={'secondary'}>
            {props.classworkSubmission.status == 'NEW' ? 'Publicado em' : 'Entregue em'}
            {' '}
    ...
    return <Collapse.Panel
        ...
        header={
            <Space>
                ...
                <Typography.Text>{props.classworkSubmission.classwork.name}</Typography.Text>
            </Space>
        }
        extra={Extra}
        showArrow={false}
        ...
        <Card
            ...
            actions={[
                <Button
                    ...
                    onClick={() => router.push(`/v2/class/${props.classworkSubmission.classId}/activity/${props.classworkSubmission._id}`)}>
                    Ver atividade
                </Button>
            ]}
            style={{
            ...
            <Row>
                <Col span={18}>
                    <Typography.Paragraph type={'secondary'}>
                        {'Item postado em '}
                        {new Date(props.classworkSubmission.createdAt).toLocaleString('pt-BR')}
                        {' '}
