    ...
    <div className="card border-0 shadow-small">
      <div className="card-body">
        ...
        <div className="d-flex align-items-center">
          ...
          <div>
            ...
            <small>
              <time>{relativeDate(props.created_at)}</time>
            </small>
          </div>
        </div>
      ...
      {props.comments_enabled && user && (
        <div className="card-footer bg-white d-flex align-items-center p-3">
          ...
          >
            <img
              src={user["avatar_url"] || "/assets/images/blank-profile.png"}
              alt={user.name}
            />
          </div>
          <Form
          ...
          >
            <Input
              name="text"
              inline="mb-0 w-100"
              cssClasses="rounded-pill d-inline"
              placeholder="Digite seu comentário..."
            />
            <Button
              color="light"
              cssClasses="rounded-pill border-0"
              title="Postar"
              style={{
                position: "absolute",
                right: "20px",
            ...
            >
              <i className="fa fa-send text-muted"></i>
            </Button>
          </Form>
        </div>
      )}
