              ...
              <div className="title-wrap">
                ...
                <Link href="/profile/update">
                  <Button color="success">
                    <i className="fa fa-edit mr-2"></i>Editar Perfil
                  </Button>
                </Link>
              </div>
            </div>
                  ...
                  <div className="row">
                    <div className="col-md-4">
                      <div className="mx-auto d-block text-center">
                        <img
                          className="rounded-circle img-fluid img-220 mx-auto d-block"
                          src="/assets/images/blank-profile.png"
                          alt="Foto do Aluno"
                        />
                        <h5 className="text-sm-center mt-2 mb-1">
                          {user.name}
                        </h5>
          ...
          <div className="row">
              ...
              <div className="card">
                <div className="card-header">
                  <strong className="card-title text-center">
                    <i className="fa fa-vial"></i> Aula Prática 1
                  </strong>
                </div>
                ...
                <div className="card-body">
                  ...
                  <button
                    className="au-btn au-btn--small au-btn--block au-btn--green m-t-20 "
                    data-toggle="modal"
                    data-target="#modal-aulapratica1"
                  >
                    Ver Discursivas
                  </button>
                </div>
            ...
            <div className="col-md-3">
              <div className="card">
                <div className="card-header">
                  <strong className="card-title text-center">
                    <i className="fa fa-vial"></i> Aula Prática 2
                  </strong>
                </div>
                ...
                <div className="card-body">
                  ...
                  <button
                    className="au-btn au-btn--small au-btn--block au-btn--green m-t-20 "
                    data-toggle="modal"
                    data-target="#modal-aulapratica2"
                  >
                    Ver Discursivas
                  </button>
                </div>
            ...
            <div className="col-md-3">
              <div className="card">
                <div className="card-header">
                  <strong className="card-title text-center">
                    <i className="fa fa-vial"></i> Aula Prática 3
                  </strong>
                </div>
                ...
                <div className="card-body">
                  ...
                  <button
                    className="au-btn au-btn--small au-btn--block au-btn--green m-t-20 "
                    data-toggle="modal"
                    data-target="#modal-aulapratica3"
                  >
                    Ver Discursivas
                  </button>
                </div>
            ...
            <div className="col-md-3">
              <div className="card">
                <div className="card-header">
                  <strong className="card-title text-center">
                    <i className="fa fa-vial"></i> Aula Prática 4
                  </strong>
                </div>
                ...
                <div className="card-body">
                  ...
                  <button
                    className="au-btn au-btn--small au-btn--block au-btn--green m-t-20 "
                    data-toggle="modal"
                    data-target="#modal-aulapratica4"
                  >
                    Ver Discursivas
                  </button>
                </div>
              ...
              <div className="table-data__tool">
                <div className="table-data__tool-left">
                  ...
                  <button className="au-btn-filter">
                    <i className="zmdi zmdi-filter-list"></i>Filtrar
                  </button>
                </div>
              </div>
