        ...
        <div className="row">
            <div className="col-12">
                <div className="card border-0 shadow-small">
                    <div className="card-body rounded text-white" style={{ color: '#fff', backgroundColor: hashToColor(`banco de dados`), height: '150px' }}>
                        <h2 className="display-4 text-white" style={{ fontSize: '2rem' }}>{resource.name}</h2>
            ...
            <div className="col-3">
                <div className="card shadow-sm">
                    ...
                    <div className="d-flex justify-content-end mb-2 mr-2">
                        <Button color="link" size="sm">Ver atividades</Button>
                    </div>
                </div>
            </div>
